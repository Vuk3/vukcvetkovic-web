...
Twenty route files cover ten logical pages, because every route exists twice: once
...
| Memory | [pages/games/memory/index.astro](./pages/games/memory/index.astro) | [pages/\[lang\]/games/memory/index.astro](<./pages/[lang]/games/memory/index.astro>) | [Memory.astro](./components/Memory.astro) |
...
all of them. Five games, five directories.
